    ...
    .then(() => {
      return User.create([
        ...
        },
        {
          ...
          password: 'password',
          passwordConfirmation: 'password',
          interests: ['make-up', 'make-over', 'sparkles'],
          avatar: avatars[10]
        },
        {
          username: 'kasia',
    ...
    .then(users => {
      ...
      return Event.create([
        ...
        },
        {
          ...
          description: 'This tournament will not be the faint hearted! I take my ping pong (aka table tennis, aka WHIFF WHAFF) exceedingly seriously so please don\'t bother RSVP-ing if you don\'t even know the TTA\'s official rules or don\'t own your own bat!!!!!',
          schedule: '',
          startTime: '1600',
          endTime: '2200',
          tickets: '',
